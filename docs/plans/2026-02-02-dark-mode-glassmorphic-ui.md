...
button[class*="bg-primary"]:hover:not(:disabled) {
  background: linear-gradient(
    135deg,
    oklch(0.8 0.19 264) 0%,
    oklch(0.7 0.22 264) 100%
  );
  box-shadow:
...
[class*="yellow"][class*="border"] {
  background: linear-gradient(
    135deg,
    oklch(0.3 0.12 70 / 0.3) 0%,
    oklch(0.25 0.12 80 / 0.3) 100%
  );
  backdrop-filter: blur(8px);
  border: 2px solid oklch(0.7 0.18 75 / 0.6) !important;
  box-shadow:
    0 4px 12px 0 oklch(0.55 0.15 75 / 0.3),
    0 0 0 1px oklch(0.6 0.15 75 / 0.2) inset;
}
...
[class*="amber"] strong,
[class*="yellow"] strong {
  color: oklch(0.9 0.18 75) !important;
  font-weight: 600;
}
